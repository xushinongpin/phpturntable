<template>
    <div class="container">
        ...
        <div class="main">
            ...
            <div class="content">
                <!--今日免费抽奖次数：-->
                <div class="lottery_ticket">Number of free draws today: {{ lottery_ticket}}</div>
            </div>
            <div class="tip">
                <!--活动规则-->
                <div class="tip-title">rule of activity</div>
                <div class="tip-content">
                    <!--每次在本店吃一次饭方可抽奖一次-->
                    <p> 1.Every time you eat once in the store, you can draw a prize once.</p>
                    <!--没有吃不能抽奖，违规账号作废-->
                    <p> 2.No food can not draw, illegal account invalidation</p>
                    <!--以上协议解释权归本店所有-->
                    <p> 3.The right to interpret the above agreement belongs to the store.</p>
                </div>
            </div>
        </div>
